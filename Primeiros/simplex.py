class Simplex:
    def __init__(self):
        self.table = []
    def set_objetivo_function (self, fo: list): #definir função objetivo
        self.table.append(fo)
    def add_restrictions (self, sa: list):
        self.table.append(sa)
    def get_entry_column(self)->int:            #encontrar o pivor, o menor numero da coluna
...
if __name__ == "__main__":
        ...
        simplex.set_objetivo_function([-1,5, -2,0,0,0])
